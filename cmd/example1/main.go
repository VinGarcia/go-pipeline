...
func main() {
	...
	p.Debug = true
	pipeline := p.New(
		p.NewStage("coolNameForStage1", threads.TaskForce(1), func(_ interface{}) (interface{}, error) {
		...
		p.NewStage("coolNameForStage3", threads.TaskForce(1), func(job interface{}) (interface{}, error) {
		...
		p.NewFanoutStage("myFanoutStage", threads.TaskForce(1),
		...
		p.NewStage(
			...
			"verySlowStage", threads.TaskForce(4),
